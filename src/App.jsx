...
import resumePdf from '../file/전우상_이력서_2026.pdf';
import portfolioPdf from '../file/전우상_포트폴리오_2026.02.18.pdf';
// --- DATA ---
const PROJECTS = [
   {
      id: 1,
      ...
      media: [
         {
            ...
            link: "https://biz.sbs.co.kr/article/20000056874"
         }
      ]
   },
   {
      ...
      media: [
         {
            ...
            link: "https://www.fnnews.com/news/202107291013149380"
         },
         {
            title: "싸이월드, 35억 원어치 ‘도토리’ 환불",
            link: "https://news.kbs.co.kr/news/pc/view/view.do?ncd=5143163"
         }
      ]
   },
   {
      ...
      media: [
         {
            ...
            link: "https://www.hani.co.kr/arti/economy/it/1049574.html"
         }
      ]
   },
   {
      ...
      media: [
         {
            ...
            link: "http://www.worktoday.co.kr/news/articleView.html?idxno=24801"
         }
      ]
   },
   {
      ...
      media: [
         {
            ...
            link: "https://www.skyedaily.com/news/news_view.html?ID=154549"
         }
      ]
   }
];
            ...
            <div className="flex flex-col gap-8">
               {['home', 'about', 'career', 'projects', 'contact'].map((item) => (
                  <a
                     key={item}
                     href={`#${item}`}
                     className={`group relative flex items-center justify-center w-full transition-all duration-300 ${activeSection === item ? 'text-blue-500' : 'text-neutral-600 hover:text-white'
                        }`}
                  >
            ...
            <section id="contact" className="min-h-[60vh] bg-blue-700 text-black flex flex-col justify-between">
               ...
               <div className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 text-center group">
                  <div className="flex flex-col md:flex-row gap-4 mt-8">
                     ...
                     <a href={resumePdf} download="전우상_이력서_2026.pdf" className="px-8 py-4 border-2 border-black font-bold hover:bg-white transition-all flex items-center gap-2">
                        <Download size={18} /> Download Resume
                     </a>
                     <a href={portfolioPdf} download="전우상_포트폴리오_2026.02.18.pdf" className="px-8 py-4 border-2 border-black font-bold hover:bg-white transition-all flex items-center gap-2">
                     ...
                     <div className="p-8 md:p-12 md:w-2/3 bg-neutral-900 text-white space-y-12">
                        ...
                        <div className="border-t border-neutral-800 pt-8 mt-8">
                           ...
                           <div className="flex flex-col gap-4">
                              {selectedProject.media && selectedProject.media.map((m, idx) => (
                                 <a
                                    key={idx}
                                    href={m.link}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 border border-neutral-700 hover:bg-white hover:text-black transition-all"
                                 >
                                    <div className="flex items-start md:items-center gap-2">
                                       <span className="text-xl">📰</span>
                                       <span className="font-bold underline decoration-1 underline-offset-4 group-hover:no-underline break-all md:break-normal line-clamp-2 md:line-clamp-none">
                                          {m.title}
                                       </span>
                                    </div>
                                    <ExternalLink size={20} className="shrink-0 hidden md:block" />
                                 </a>
                              ))}
                           </div>
                        </div>
